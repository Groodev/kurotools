  ...
  return (
    <section className="relative pt-8 pb-16 md:pt-14 md:pb-24 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden max-w-6xl mx-auto">
        ...
        >
          <div 
            className="clay-badge bg-white/90 text-clayPurple-dark border border-purple-100 shadow-clay-card animate-float-slow flex items-center gap-2 px-4 py-2 cursor-pointer hover:scale-110"
        ...
        >
          <div 
            className="clay-badge bg-white/90 text-purple-700 border border-purple-100 shadow-clay-card animate-float-medium flex items-center gap-2 px-4 py-2 cursor-pointer hover:scale-110"
            onClick={() => setActiveTab('downloader')}
            title="Buka Media Downloader"
          >
        ...
        >
          <div 
            className="clay-badge bg-white/90 text-emerald-800 border border-emerald-100 shadow-clay-card animate-float-fast flex items-center gap-2 px-4 py-2 cursor-pointer hover:scale-110"
        ...
        >
          <div 
            className="clay-badge bg-white/90 text-orange-800 border border-orange-100 shadow-clay-card animate-float-slow flex items-center gap-2 px-4 py-2 cursor-pointer hover:scale-110"
